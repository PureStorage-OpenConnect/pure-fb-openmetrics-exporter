from pure_fb_prometheus_exporter.flashblade_collector.flashblade_metrics.buckets_s3_specific_performance_metrics import BucketsS3SpecificPerformanceMetrics
